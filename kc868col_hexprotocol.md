...
| --- | --- | --- | --- |
| 1 <td colspan=2>mark bit</td>| 0x 5E |
| 1 <td colspan=2>version number</td>| 0x01 |
| 2 <td colspan=2>message type</td>| 0x01 (low byte)/ 0xC0 (high byte) |
| 2 <td colspan=2>message length</td>|N (low byte) / N>>8 (high byte) |
| 38 <td colspan=2>spare</td>| 0x00 |
